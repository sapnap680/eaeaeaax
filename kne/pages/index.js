              ...
              <div style={{
                ...
                <div style={{ marginTop: '12px' }}>
                  <div style={{
                    ...
                    <span style={{ whiteSpace: 'nowrap', fontSize: '1.0em' }}>氏名</span>
                    <span style={{
                      position: 'absolute',
                      left: '50%',
                ...
                <div style={{ marginTop: '10px' }}>
                  <div style={{
                    ...
                    <span style={{
                      position: 'absolute',
                      left: '0',
                      right: 'calc(1.0em + 10px)',
                      whiteSpace: 'nowrap',
                      fontSize: '1.0em',
                      textAlign: 'right',
                      overflow: 'visible'
                    }}>{university || ''}</span>
                    <span style={{ marginLeft: 'auto', whiteSpace: 'nowrap', fontSize: '1.0em' }}>大学</span>
                  </div>
                  <hr style={{ border: 'none', borderBottom: '2px solid #222', margin: '5px 0 0 0' }} />
                </div>
                ...
                >
                  {validType === '今大会のみ' ? (
                    <>
                      <span style={{ fontSize: '1.0em' }}>※</span>
                      <strong style={{ fontSize: '1.0em', fontWeight: 'bold', display: 'inline-block', lineHeight: 1 }}>今大会</strong>
                      <span style={{ fontSize: '1.0em' }}>のみ有効</span>
                    </>
                  ) : (
                    <>
                      <span style={{ fontSize: '1.0em' }}>※</span>
                      <strong style={{ fontSize: '1.0em', fontWeight: 'bold', display: 'inline-block', lineHeight: 1 }}>{validDateOnly}</strong>
                      <span style={{ fontSize: '1.0em' }}>のみ有効</span>
                    </>
                  )}
                </div>
